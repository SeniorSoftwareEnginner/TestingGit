package md5de6d21b34101e9947fc3d82ad469abf1;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GPSTracker.TrackingService, GPSTracker, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TrackingService.class, __md_methods);
	}


	public TrackingService () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TrackingService.class)
			mono.android.TypeManager.Activate ("GPSTracker.TrackingService, GPSTracker, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
